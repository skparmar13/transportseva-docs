...
export class HomeComponent implements OnInit {
  ...
  protected readonly testimonials = signal([
    { textKey: 'testi1.text', name: 'Rakesh Sharma', roleKey: 'testi1.role' },
    { textKey: 'testi2.text', name: 'Vikram Singh', roleKey: 'testi2.role' },
    { textKey: 'testi3.text', name: 'Neha Verma', roleKey: 'testi3.role' },
  ]);
